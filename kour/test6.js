...
(function(){
  ...
  window.WebSocket = function(url, protocols){
    ...
    stub.send = (msg) => sendRelay({ type:"send", connId, isBinary: msg instanceof ArrayBuffer, payload: msg instanceof ArrayBuffer ? btoa(String.fromCharCode(...new Uint8Array(msg))) : msg });
