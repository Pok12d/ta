                ...
                function e(t) {
                    ...
                    this.rewardedBreak = function(e, t, o, r) {
                        return new Promise((function(a) {
                            ...
                            void 0 !== r && (d.placement = r)) : (void 0 !== e && (d.category = e),
                ...
                return e.prototype.init = function(e) {
                    ...
                    new Promise((function(n) {
                        ...
                        r.Z.sendMessage(i.Z.message.sdkDetails, {
                            version: "a7c3d8457e9d001550c049f821d50d7c386f7a05"
                        })
                    }
                    ))
                }
        ...
        902: (e, t, n) => {
            ...
            const s = function(e) {
                ...
                if ("undefined" != typeof window && "undefined" != typeof fetch) {
                    ...
                    i.Z.debug ? console.log("PokiAdServer Tracking: ", d) : fetch("https://t.poki.io/adserver", {
                        method: "POST",
                        mode: "no-cors",
    ...
    ( () => {
        ...
        const P = function() {
            function t(t) {
                ...
                (null == t ? void 0 : t.fake) || (_.Z.addEventListener(e.Z.ads.requested, this.startTimeBetweenAdsTimer.bind(this)),
                _.Z.addEventListener(e.Z.ads.completed, this.startTimeBetweenAdsTimer.bind(this)),
                _.Z.addEventListener(e.Z.ads.stopped, this.startTimeBetweenAdsTimer.bind(this)))
            }
        ...
        function U() {
            ...
            return e.searchParams.append("game_id", n.Z.gameID),
                ...
                if (!(--A > 0))
                    try {
                        var h = l
                          , f = void 0;
                        if (de()) {
                            _.Z.dispatchEvent(e.Z.ads.prebidRequested, {
                                blocked: X()
                            });
                            ...
                            v.length > 0 && (f = v[0]),
                            f && (null === (a = null === (r = null == f ? void 0 : f.meta) || void 0 === r ? void 0 : r.advertiserDomains) || void 0 === a ? void 0 : a.length) > 0 && _.Z.setVideoDataAnnotations({
                        ...
                        s) {
                            ...
                            !f || !f.videoCacheKey)
                                return void _.Z.dispatchEvent(1 === d ? e.Z.ads.video.error : e.Z.ads.completed, {
                                    rewardAllowed: !1
                                });
                            switch (f.bidder) {
                            case "onetag":
        ...
        function pe() {
            ...
            return "yes" === (0,
            M.Z)("poki-ad-server") ? (console.log("DEBUG: Only running Poki-ad-server"),
            !0) : ("localhost" === t || "game-cdn.poki.com" === t || t.endsWith(".poki-gdn.com"),
            !1)
        }
        var Ae, he = !1, fe = n.Z.testVideos, me = n.Z.device, ve = function() {
            ...
            "desktop" === me || (null === document || void 0 === document ? void 0 : document.fullscreenElement) ? _.Z.dispatchEvent(e.Z.ads.video.startHouseAdFlow) : window.googletag.cmd.push((function() {
                t.Z.track(e.Z.tracking.ads.rewardedWeb.request),
                function(e) {
                    googletag.defineOutOfPageSlot && (Ae && googletag.destroySlots([Ae]),
                ...
                Ae ? window.googletag.cmd.push((function() {
            ...
            return t.prototype.moveThroughWaterfall = function() {
                if (this.runningBackfill)
                    ...
                    void _.Z.dispatchEvent(e.Z.ads.error, {
                ...
                if (!1 !== this.running) {
                    ...
                    this.rewarded ? ge(this.criteria) : _.Z.dispatchEvent(e.Z.ads.error, {
                        message: "No ads"
                    })
                }
            }
            ...
            t.prototype.requestAd = function() {
                ...
                _.Z.dispatchEvent(e.Z.ads.requested),
                i.Z.debug ? (console.debug("adRequest started in debug mode (".concat(this.retries, "/").concat(this.totalRetries, ")")),
                this.ima.requestAd(U())) : this.usePokiAdserver ? (console.debug("adRequest started with Prebid Video enabled (".concat(this.retries, "/").concat(this.totalRetries, ")")),
                ue(this.ima, c, this.criteria, this.rewarded, this.country, !0, this.retries)) : 1 === this.retries ? (console.debug("adRequest started with Prebid Video enabled (".concat(this.retries, "/").concat(this.totalRetries, ")")),
                ue(this.ima, c, this.criteria, this.rewarded, this.country, !1, this.retries)) : (console.debug("adRequest started in plain mode (".concat(this.retries, "/").concat(this.totalRetries, ")")),
        ...
        const ke = function() {
            ...
            t.prototype.start = function() {
                this.activeQueue.length > 0 || (this.activeQueue = we([], this.storedQueue, !0),
                this.active = !0,
                this.continue())
            }
            ,
            ...
            t.prototype.tick = function() {
                ...
                this.fakeProgressEvents && _.Z.dispatchEvent(e.Z.ads.video.progress, {
        ...
        var Ze = "pokiSdkContainer"
          ...
          , Me = "pokiSdkSpinnerContainer"
          , Re = "pokiSdkVideoContainer"
          , ze = "pokiSdkVisible"
          ...
          , Ne = function() {
            ...
            t.prototype.createElements = function(e) {
                ...
                this.containerDiv.className = Ze,
                this.insideContainer.className = xe,
                this.pauseButtonContainer.className = Se,
                this.pauseButton.className = Te,
                this.pauseButtonBG.className = _e,
                this.pauseButtonContainer.appendChild(this.pauseButton),
                this.pauseButtonContainer.appendChild(this.pauseButtonBG),
                this.startAdButton.className = Pe,
                this.startAdButton.innerHTML = "Tap anywhere to play ad",
                this.progressBar.className = De,
                this.progressContainer.className = Be,
                this.spinnerContainer.className = Me,
                this.adContainer.className = je,
                this.videoContainer.className = Re,
                this.hide(),
                ...
                var n = e || null
                  , i = function() {
                    ...
                    n)
                        ...
                        n === document.body)
                            t.containerDiv.classList.add(Ee);
                        else {
            ...
            t.prototype.startNonIMAFallbackVideo = function(t) {
                ...
                var a = function(t) {
                    ...
                    t || _.Z.dispatchEvent(e.Z.ads.completed, {
                        rewardAllowed: o
                    })
                };
                ...
                i.onplaying = function() {
                    _.Z.dispatchEvent(e.Z.ads.started, {
                        creativeId: "HouseAd",
                        duration: t.duration
                    }),
                    _.Z.dispatchEvent(e.Z.ads.impression),
        ...
        const Ve = function() {
            ...
            t.prototype.onAdsManagerLoaded = function(t) {
                ...
                _.Z.dispatchEvent(e.Z.ads.ready)) : this.tearDown()
            }
            ,
            ...
            t.prototype.resumeAd = function() {
                _.Z.dispatchEvent(e.Z.ads.video.resumed),
            ...
            t.prototype.onAdEvent = function(t) {
                ...
                case google.ima.AdEvent.Type.STARTED:
                    ...
                    i.isLinear() || (this.bannerTimeout = window.setTimeout((function() {
                        ...
                        _.Z.dispatchEvent(e.Z.ads.completed, {
                ...
                case google.ima.AdEvent.Type.PAUSED:
                    ...
                    _.Z.dispatchEvent(e.Z.ads.video.paused);
                    break;
                ...
                case google.ima.AdEvent.Type.SKIPPED:
                    _.Z.dispatchEvent(e.Z.ads.skipped),
                    this.completeOnce && (this.completeOnce = !1,
                    _.Z.dispatchEvent(e.Z.ads.completed, {
                        rewardAllowed: this.videoStarted
                    })),
            ...
            t.prototype.onAdLoaderError = function(t) {
                ...
                _.Z.dispatchEvent(e.Z.ads.video.loaderError, {
                    message: i,
                    errorCode: o
                })
            }
            ...
            t.prototype.onAdError = function(t) {
                ...
                var n = null == t ? void 0 : t.getError()
                  , i = (null == n ? void 0 : n.toString()) || "Unknown"
                  , o = (null == n ? void 0 : n.getErrorCode()) || 0;
                _.Z.dispatchEvent(e.Z.ads.video.error, {
                    message: i,
                    errorCode: o
                })
            }
        ...
        var nt = function() {
            function o() {
                ...
                this.requestHouseAd = function(i, o) {
                    ...
                    fetch("https://api.poki.com/ads/houseads/display/".concat(i.width, "x").concat(i.height, "?game_id=").concat(n.Z.gameID, "&site=").concat(n.Z.siteID)).then((function(e) {
                        return e.json()
                    }
                    )).then((function(n) {
            ...
            o.prototype.renderAd = function(e) {
                ...
                w.intersectionObserver = new window.IntersectionObserver((function(e) {
                    ...
                    i.Z.debug ? n.requestHouseAd(w, {
                        ...
                        refreshType: (null === (o = w.criteria) || void 0 === o ? void 0 : o.refreshType) || "",
                        duringGameplay: null === (r = w.duringGameplay) || void 0 === r ? void 0 : r.call(w),
        ...
        function() {
          ...
          , ht = function() {
            function o() {
                ...
                this.runNonIMAVideoHouseAd = function(t) {
                    ...
                    function() {
                        ...
                        _.Z.dispatchEvent(e.Z.ads.error, ct(ct({}, t), {
            ...
            o.prototype.loadPokiSettings = function() {
                ...
                return Promise.allSettled(b).then((function(r) {
                    ...
                    try {
                            ...
                            if (A) {
                                ...
                                var h = function(i) {
                                    ...
                                    if (r || a) {
                                        ...
                                        w.Z)() && !(0,
                                        E.Z)() && n.Z.isPokiIframe && !Z && "GB" !== n.Z.country;
                        ...
                        H = c || [],
                        o.strictConsentMode && _.Z.dispatchEvent(e.Z.ready),
                        n.Z.isPlayground || o.loadMonetizationCore()
                    } catch (t) {
                        _.Z.dispatchEvent(e.Z.adblocked, {
                            message: "".concat(t)
                        })
                    }
                }
                ...
                return lt(this, void 0, void 0, (function() {
                    ...
                    return ut(this, (function(Z) {
                        ...
                        case 0:
                            ...
                            A = o.displayOnly,
                            h = void 0 !== A && A,
                            f = ct({}, this.initOptions),
                            m = f.nonPersonalized,
                            v = void 0 !== m && m,
                            g = f.familyFriendly,
                            y = void 0 !== g && g,
                            n.Z.isInspector ? (this.strictConsentMode || _.Z.dispatchEvent(e.Z.ready),
                        ...
                        case 2:
                            return w.push((0,
                            b.Z)("https://securepubads.g.doubleclick.net/tag/js/gpt.js")),
                            h || w.push((0,
                            b.Z)("https://imasdk.googleapis.com/js/sdkloader/ima3.js")),
                            ...
                            b.Z)("https://a.poki.com/prebid/prebid8.16.0.js"), (0,
                            b.Z)("https://c.amazon-adsystem.com/aax2/apstag.js")),
                                ...
                                try {
                                    ...
                                    window.googletag.cmd.push((function() {
                                        ...
                                        googletag.pubads().addEventListener("rewardedSlotClosed", (function() {
                                            var n, i, o;
                                            he ? t.Z.track(e.Z.tracking.ads.rewardedWeb.closedGranted) : t.Z.track(e.Z.tracking.ads.rewardedWeb.closedDeclined),
                                        ...
                                        googletag.pubads().addEventListener("slotRenderEnded", (function(n) {
                                            var i;
                                            ve() === (null === (i = null == n ? void 0 : n.slot) || void 0 === i ? void 0 : i.getAdUnitPath()) && n.isEmpty && (t.Z.track(e.Z.tracking.ads.rewardedWeb.empty),
                                            _.Z.dispatchEvent(e.Z.ads.video.startHouseAdFlow))
                                        }
                                        )),
                                    ...
                                    c.customCriteria = ct(ct({}, c.customCriteria), {
                                        force_ad: u
                                    })),
                                    k.criteria = ct({}, c.customCriteria),
                                    k.ima = new Ve(l),
                                    k.playerSkin.setupEvents(k),
                                    k.startStartAdsAfterTimerOnInit && At.startStartAdsAfterTimer(),
                                    k.waterfall = new be(k.ima,{
                                        timing: At,
                                        totalRetries: p
                                    }),
                                    k.monetizationCoreLoaded = !0,
                                    k.GPTRejected && k.IMARejected)
                                        return void _.Z.dispatchEvent(e.Z.adblocked, {
            ...
            o.prototype.requestAd = function(o) {
                ...
                if (t.Z.track(y === e.Z.ads.position.rewarded ? e.Z.tracking.screen.rewardedBreak : e.Z.tracking.screen.commercialBreak, ct(ct({}, o.rewardedKVs), b)),
                this.videoRequestInFlight)
                    _.Z.dispatchEvent(e.Z.ads.inFlight, ct(ct({}, b), {
                        onFinish: A
                    }));
                else if (this.videoRequestInFlight = !0,
                this.autoStartOnReady = !1 !== u,
                this.registerHandler("onFinish", (function(t) {
                    _.Z.dispatchEvent(e.Z.playtest.stopVideo),
                    A && A(t)
                }
                )),
                this.registerHandler("onStart", (function(t) {
                    _.Z.dispatchEvent(e.Z.playtest.startVideo, {
                        position: y
                    }),
                    f && f(t)
                }
                ...
                I.Z)(y, e.Z.ads.position))
                    if (this.displayOnly)
                        _.Z.dispatchEvent(e.Z.ads.error, ct(ct({}, b), {
                            message: "Video disabled"
                        }));
                    else {
                        if (!this.sdkBooted)
                            return _.Z.dispatchEvent(e.Z.ads.error, ct(ct({}, b), {
                        ...
                        E.Z)()) && y !== e.Z.ads.position.rewarded)
                            if ("evoworld.io" !== ((null === (r = null === window || void 0 === window ? void 0 : window.location) || void 0 === r ? void 0 : r.hostname) || ""))
                                return void _.Z.dispatchEvent(e.Z.ads.error, ct(ct({}, b), {
                        ...
                        if ((null === (s = null === (a = this.ima) || void 0 === a ? void 0 : a.isAdRunning) || void 0 === s ? void 0 : s.call(a)) || (null === (c = null === (d = this.waterfall) || void 0 === d ? void 0 : d.isRunning) || void 0 === c ? void 0 : c.call(d)))
                            _.Z.dispatchEvent(e.Z.ads.busy, b);
                        else if (y !== e.Z.ads.position.preroll || At.prerollPossible())
                            if (y === e.Z.ads.position.rewarded || At.requestPossible())
                                if (y !== e.Z.ads.position.rewarded && this.adSettings.countryExclusion.includes(n.Z.country))
                                    _.Z.dispatchEvent(e.Z.ads.limit, ct(ct({}, b), {
                                        reason: e.Z.info.messages.disabled
                                    }));
                                else {
                                    if (this.strictConsentMode && !this.monetizationCoreLoaded)
                                        return y === e.Z.ads.position.rewarded || i.Z.debug ? void this.runNonIMAVideoHouseAd(b) : void _.Z.dispatchEvent(e.Z.ads.error, ct(ct({}, b), {
                                            messaage: "Ad libraries not yet loaded"
                                        }));
                                    if (!this.ima || this.sdkImaError || this.IMARejected)
                                        y === e.Z.ads.position.rewarded ? this.runNonIMAVideoHouseAd(b) : _.Z.dispatchEvent(e.Z.ads.error, ct(ct({}, b), {
                                        ...
                                        _.Z.dispatchEvent(e.Z.ads.ready, b);
                                    else {
                                        _.Z.clearVideoDataAnnotations(),
                                        _.Z.setVideoDataAnnotations(b);
                                        var k = ct(ct(ct({}, this.genericCriteria()), this.criteria), {
                                            position: y,
            ...
            o.prototype.displayAd = function(t) {
                ...
                !0) : this.strictConsentMode && !this.monetizationCoreLoaded ? (_.Z.dispatchEvent(e.Z.ads.error, {
                    messaage: "Ad libraries not yet loaded"
                }),
                !1) : this.GPTRejected ? (_.Z.dispatchEvent(e.Z.ads.error, {
                    message: "Bot, IMA or Adblocker error"
                }),
                !1) : v() ? (_.Z.dispatchEvent(e.Z.ads.error, {
                    message: "No TCFv2 CMP detected, please contact developersupport@poki.com for more information"
                }),
                !1) : g() ? (_.Z.dispatchEvent(e.Z.ads.error, {
                    message: "No USP detected, please contact developersupport@poki.com for more information"
                }),
                !1) : r ? this.sdkBooted ? o ? void 0 === window.googletag ? (_.Z.dispatchEvent(e.Z.ads.error, {
                    message: "Adblocker has been detected"
                }),
                !1) : this.adSettings.countryExclusion.includes(n.Z.country) ? (_.Z.dispatchEvent(e.Z.ads.limit, {
                    reason: e.Z.info.messages.disabled
                }),
                !1) : this.display.validateDisplaySettings(r) ? (this.display.renderAd(t),
                !0) : (_.Z.dispatchEvent(e.Z.ads.error, {
                    reason: "Display size ".concat(r, " is not supported on this device")
                }),
                !1) : (_.Z.dispatchEvent(e.Z.ads.error, {
            ...
            o.prototype.startStartAdsAfterTimer = function() {
                this.sdkNotBootedButCalled() ? this.startStartAdsAfterTimerOnInit = !0 : At.startStartAdsAfterTimer()
            }
            ,
            ...
            o.prototype.forcePreroll = function() {
                if (!this.sdkNotBootedButCalled()) {
                    var t = At.prerollPossible;
                    At.prerollPossible = function() {
                        return !0
                    }
                    ,
                    this.requestAd({
            ...
            o.prototype.stopVideoAd = function() {
                ...
                _.Z.dispatchEvent(e.Z.ads.stopped),
            ...
            o.prototype.startAd = function() {
                ...
                this.ima.startPlayback()) : _.Z.dispatchEvent(e.Z.ads.error, {
            ...
            o.prototype.setupDefaultEvents = function() {
                ...
                _.Z.addEventListener(e.Z.ads.inFlight, (function(t) {
                    var n, i = ct({}, t);
                    delete i.onFinish,
                    null === (n = t.onFinish) || void 0 === n || n.call(t, ct(ct({}, i), {
                        type: e.Z.ads.busy,
                        rewardAllowed: !1
                    }))
                }
        ...
        const ft = ht;
        var mt = new (a(95).ZP)(new ft);
        for (var vt in mt)
            window.PokiSDK[vt] = mt[vt]
    }
    )()
}
)();
