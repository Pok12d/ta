    ...
    try {
        !(function() {
            ...
            const n = {
                ...
                encodeString(e, t) {
                    return this.HAS_NATIVE_SUPPORT && !t ? btoa(e) : this.encodeByteArray(function(t) {
                        ...
                        for (let i = 0; i < t.length; i++) {
                            ...
                            e < 128 ? r[n++] = e : (e < 2048 ? r[n++] = e >> 6 | 192 : (55296 == (64512 & e) && i + 1 < t.length && 56320 == (64512 & t.charCodeAt(i + 1)) ? (e = 65536 + ((1023 & e) << 10) + (1023 & t.charCodeAt(++i)),
                            r[n++] = e >> 18 | 240,
                            r[n++] = e >> 12 & 63 | 128) : r[n++] = e >> 12 | 224,
                            r[n++] = e >> 6 & 63 | 128),
                            r[n++] = 63 & e | 128)
                        }
                        return r
                ...
                decodeString(e, t) {
                    return this.HAS_NATIVE_SUPPORT && !t ? atob(e) : function(e) {
                        ...
                        for (; r < e.length; ) {
                            var i, s, a = e[r++];
                            a < 128 ? t[n++] = String.fromCharCode(a) : 191 < a && a < 224 ? (i = e[r++],
                            t[n++] = String.fromCharCode((31 & a) << 6 | 63 & i)) : 239 < a && a < 365 ? (s = ((7 & a) << 18 | (63 & e[r++]) << 12 | (63 & e[r++]) << 6 | 63 & e[r++]) - 65536,
                            t[n++] = String.fromCharCode(55296 + (s >> 10)),
                            t[n++] = String.fromCharCode(56320 + (1023 & s))) : (i = e[r++],
                            s = e[r++],
                            t[n++] = String.fromCharCode((15 & a) << 12 | (63 & i) << 6 | 63 & s))
                        }
                        return t.join("")
            ...
            class p {
                ...
                create(e, ...t) {
                    var n, r = t[0] || {}, i = `${this.service}/${e}`, s = this.errors[e], s = s ? (n = r,
                    s.replace(f, (e, t) => {
                        var r = n[t];
                        return null != r ? String(r) : `<${t}?>`
                    }
                    )) : "Error", s = `${this.serviceName}: ${s} (${i}).`;
                    return new h(i,s,r)
                }
            }
            const f = /\{\$([^}]+)}/g;
            ...
            ("@firebase/auth");
            function D(e, ...t) {
                L.logLevel <= r.ERROR && L.error(`Auth (${li.SDK_VERSION}): ${e}`, ...t)
            }
            function M(e, ...t) {
                throw V(e, ...t)
            }
            ...
            function F(e, t, r) {
                var n = Object.assign(Object.assign({}, P()), {
                    [t]: r
                });
            ...
            function x(e, t, r) {
                if (!(t instanceof r))
                    throw r.name !== t.constructor.name && M(e, "argument-error"),
                    F(e, "argument-error", `Type of ${t.constructor.name} does not match expected instance.` + "Did you pass a reference from a different Auth SDK?")
            }
            function V(e, ...t) {
                if ("string" == typeof e)
                    return C.create(e, ...t);
            ...
            function z(e) {
                ...
                let t = q.get(e);
                return t ? H(t instanceof e, "Instance stored in cache mismatched with class") : (t = new e,
                q.set(e, t)),
                t
            }
            function B() {
            ...
            class $ {
                constructor(e, t) {
                    H((this.shortDelay = e) < (this.longDelay = t), "Short delay should be less than long delay!"),
                    this.isMobile = "undefined" != typeof window && !!(window.cordova || window.phonegap || window.PhoneGap) && /ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(d()) || l()
                }
                get() {
                    return "undefined" != typeof navigator && navigator && "onLine"in navigator && "boolean" == typeof navigator.onLine && (G() || o() || "connection"in navigator) && !navigator.onLine ? Math.min(5e3, this.shortDelay) : this.isMobile ? this.longDelay : this.shortDelay
                }
            }
            function J(e, t) {
            ...
            class Y {
                ...
                static fetch() {
                    return this.fetchImpl || ("undefined" != typeof self && "fetch"in self ? self.fetch : void W("Could not find fetch implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill"))
                }
                static headers() {
                    return this.headersImpl || ("undefined" != typeof self && "Headers"in self ? self.Headers : void W("Could not find Headers implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill"))
                }
                static response() {
                    return this.responseImpl || ("undefined" != typeof self && "Response"in self ? self.Response : void W("Could not find Response implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill"))
                }
            }
            const X = {
            ...
            async function ee(i, s, a, o, e={}) {
                return te(i, e, async () => {
                    ...
                    Y.fetch()(ne(i, i.config.apiHost, a, r), Object.assign({
                        method: s,
                        headers: n,
            ...
            async function te(t, e, r) {
                ...
                try {
                        ...
                        return i;
                    {
                        ...
                        if ("EMAIL_EXISTS" === c)
                            throw se(t, "email-already-in-use", i);
                        if ("USER_DISABLED" === c)
                            throw se(t, "user-disabled", i);
            ...
            async function re(e, t, r, n, i={}) {
                ...
                return "mfaPendingCredential"in s && M(e, "multi-factor-auth-required", {
                    _serverResponse: s
                }),
                s
            }
            function ne(e, t, r, n) {
                var i = `${t}${r}?${n}`;
                return e.config.emulator ? J(e.config, i) : `${e.config.apiScheme}://${i}`
            }
            class ie {
                constructor(e) {
                    this.auth = e,
                    ...
                    this.promise = new Promise( (e, t) => {
                        this.timer = setTimeout( () => t(U(this.auth, "network-request-failed")), Z.get())
                    }
                    )
                }
                clearNetworkTimeout() {
            ...
            function le(e) {
                ...
                try {
                    var i = s(r);
                    return i ? JSON.parse(i) : (D("Failed to decode base64 JWT payload"),
                    null)
                } catch (e) {
                    return D("Caught error parsing JWT payload as JSON", null === e || void 0 === e ? void 0 : e.toString()),
                    null
                }
            }
            async function ce(t, r, e=!1) {
                if (e)
                    return r;
                try {
                    return r
                } catch (e) {
                    throw e instanceof h && (r = [e["code"]][0],
                    "auth/user-disabled" === r || "auth/user-token-expired" === r) && t.auth.currentUser === t && await t.auth.signOut(),
                    e
                }
            }
            class ue {
                ...
                schedule(e=!1) {
                    var t;
                    this.isRunning && (t = this.getInterval(e),
            ...
            async function he(e) {
                var t = e.auth
                  ...
                  , n = await ce(e, async function(e, t) {
                ...
                var s, a, t = null !== (r = i.providerUserInfo) && void 0 !== r && r.length ? i.providerUserInfo.map(e => {
                    var t = e["providerId"]
                      , r = w(e, ["providerId"]);
                    return {
                        providerId: t,
                ...
                a = t,
                [...s.filter(t => !a.some(e => e.providerId === t.providerId)), ...a]), r = e.isAnonymous, t = !(e.email && i.passwordHash || null !== n && n.length), t = !!r && t, t = {
                    uid: i.localId,
            ...
            class pe {
                ...
                updateFromServerResponse(e) {
                    ...
                    var t, r, r = "expiresIn"in e && void 0 !== e.expiresIn ? Number(e.expiresIn) : (t = e.idToken,
                    j(r = le(t), "internal-error"),
                ...
                async getToken(e, t=!1) {
                    return j(!this.accessToken || this.refreshToken, e, "user-token-expired"),
                ...
                async refresh(e, t) {
                    var i, s, {accessToken: r, refreshToken: n, expiresIn: a} = (s = t,
                    await {
                        accessToken: (a = await te(i = e, {}, async () => {
                            ...
                            const n = await i._getAdditionalHeaders();
                            return n["Content-Type"] = "application/x-www-form-urlencoded",
                            Y.fetch()(r, {
                                method: "POST",
                                headers: n,
                                body: e
                ...
                static fromJSON(e, t) {
                    ...
                    const s = new pe;
                    return r && (j("string" == typeof r, "internal-error", {
                        appName: e
                    }),
                    s.refreshToken = r),
                    n && (j("string" == typeof n, "internal-error", {
                        appName: e
                    }),
                    s.accessToken = n),
                    i && (j("number" == typeof i, "internal-error", {
                        appName: e
                    }),
                    s.expirationTime = i),
                    s
            ...
            class ve {
                constructor(e) {
                    ...
                    this.metadata = new de(i.createdAt || void 0,i.lastLoginAt || void 0)
                }
                async getIdToken(e) {
                    var t = await ce(this, this.stsTokenManager.getToken(this.auth, e));
                ...
                _assign(e) {
                    this !== e && (j(this.uid === e.uid, this.auth, "internal-error"),
                ...
                _clone(e) {
                    return new ve(Object.assign(Object.assign({}, this), {
                        auth: e,
                ...
                async delete() {
                    ...
                    return await ce(this, async function(e, t) {
                ...
                static _fromJSON(e, t) {
                    ...
                    const {uid: u, emailVerified: d, isAnonymous: h, providerData: p, stsTokenManager: f} = t;
                    j(u && f, e, "internal-error");
                    var v = pe.fromJSON(this.name, f);
                    ...
                    return p && Array.isArray(p) && (m.providerData = p.map(e => Object.assign({}, e))),
            ...
            class ye {
                ...
                async getCurrentUser() {
                    ...
                    return e ? ve._fromJSON(this.auth, e) : null
                }
                removeCurrentUser() {
                ...
                static async create(e, t, r="authUser") {
                    ...
                    return i._shouldAllowMigration && c.length && (i = c[0],
            ...
            function Oe(e=d()) {
                return Ae(e) || Ee(e) || Se(e) || Re(e) || /windows phone/i.test(e) || ke(e)
            }
            function Ne(e, t=[]) {
                let r;
                switch (e) {
                ...
                return `${r}/JsCore/${li.SDK_VERSION}/${n}`
            }
            class Pe {
                constructor(e) {
                    this.auth = e,
                    ...
                    if (this.auth.currentUser !== e) {
                        ...
                        try {
                            ...
                            throw this.auth._errorFactory.create("login-blocked", {
                                originalMessage: null === e || void 0 === e ? void 0 : e.message
                            })
                        }
                    }
                }
            ...
            class Ce {
                ...
                _initializeWithPersistence(t, r) {
                    return r && (this._popupRedirectResolver = z(r)),
                    this._initializationPromise = this.queue(async () => {
                        var e;
                        if (!this._deleted && (this.persistenceManager = await ye.create(this, t),
                        !this._deleted)) {
                            if (null !== (e = this._popupRedirectResolver) && void 0 !== e && e._shouldInitProactively)
                                try {
                                    await this._popupRedirectResolver._initialize(this)
                                } catch (e) {}
                            await this.initializeCurrentUser(r),
                            this.lastNotifiedUid = (null === (e = this.currentUser) || void 0 === e ? void 0 : e.uid) || null,
                ...
                async _onStorageEvent() {
                    if (!this._deleted) {
                        ...
                        if (this.currentUser || e)
                            return this.currentUser && e && this.currentUser.uid === e.uid ? (this._currentUser._assign(e),
                            void await this.currentUser.getIdToken()) : void await this._updateCurrentUser(e, !0)
                    }
                }
                async initializeCurrentUser(e) {
                    var t, r, n, i = await this.assertedPersistence.getCurrentUser();
                    let s = i
                      , a = !1;
                    if (e && this.config.authDomain && (await this.getOrInitRedirectPersistenceManager(),
                    t = null === (n = this.redirectUser) || void 0 === n ? void 0 : n._redirectEventId,
                    r = null === s || void 0 === s ? void 0 : s._redirectEventId,
                    n = await this.tryRedirectSignIn(e),
                    t && t !== r || null == n || !n.user || (s = n.user,
                    a = !0)),
                    !s)
                    ...
                    if (s._redirectEventId)
                        ...
                        this.redirectUser && this.redirectUser._redirectEventId === s._redirectEventId ? this.directlySetCurrentUser(s) : this.reloadAndSetCurrentUserOrClear(s);
                    if (a)
                        try {
                ...
                async reloadAndSetCurrentUserOrClear(e) {
                    try {
                        ...
                        if ("auth/network-request-failed" !== (null === e || void 0 === e ? void 0 : e.code))
                            return this.directlySetCurrentUser(null)
                    }
                ...
                async updateCurrentUser(e) {
                    const t = e ? I(e) : null;
                    return t && j(t.auth.config.apiKey === this.config.apiKey, this, "invalid-user-token"),
                    this._updateCurrentUser(t && t._clone(this))
                }
                async _updateCurrentUser(e, t=!1) {
                    if (!this._deleted)
                        return e && j(this.tenantId === e.tenantId, this, "tenant-id-mismatch"),
                ...
                async getOrInitRedirectPersistenceManager(e) {
                    var t;
                    return this.redirectPersistenceManager || (j(t = e && z(e) || this._popupRedirectResolver, this, "argument-error"),
                    this.redirectPersistenceManager = await ye.create(this, [z(t._redirectPersistence)], "redirectUser"),
                ...
                async _redirectUserForId(e) {
                    ...
                    (null === (t = this._currentUser) || void 0 === t ? void 0 : t._redirectEventId) === e ? this._currentUser : (null === (t = this.redirectUser) || void 0 === t ? void 0 : t._redirectEventId) === e ? this.redirectUser : null
                }
                ...
                notifyAuthListeners() {
                    var e;
                    this._isInitialized && (this.idTokenSubscription.next(this.currentUser),
                    e = null !== (e = null === (e = this.currentUser) || void 0 === e ? void 0 : e.uid) && void 0 !== e ? e : null,
                    this.lastNotifiedUid !== e && (this.lastNotifiedUid = e,
                ...
                registerStateListener(e, t, r, n) {
                    ...
                    return j(s, this, "internal-error"),
                ...
                async directlySetCurrentUser(e) {
                    ...
                    (this.currentUser = e) ? await this.assertedPersistence.setCurrentUser(e) : await this.assertedPersistence.removeCurrentUser()
                }
                queue(e) {
                ...
                _logFramework(e) {
                    ...
                    this.clientVersion = Ne(this.config.clientPlatform, this._getFrameworks()))
                }
                _getFrameworks() {
                ...
                async _getAdditionalHeaders() {
                    ...
                    return t && (e["X-Firebase-Client"] = t),
                    e
                }
            }
            function Le(e) {
                ...
                async _getIdTokenResponse(e) {
                    ...
                    case "password":
                        return async function(e, t) {
                            return re(e, "POST", "/v1/accounts:signInWithPassword", Q(e, t))
                        }(e, {
                            returnSecureToken: !0,
                            email: this._email,
                            password: this._password
                    ...
                    case "emailLink":
                        return async function(e, t) {
                            return re(e, "POST", "/v1/accounts:signInWithEmailLink", Q(e, t))
                        }(e, {
                            email: this._email,
            ...
            class ze extends xe {
                ...
                static _fromParams(e) {
                    ...
                    t.secret = e.oauthTokenSecret) : M("argument-error"),
                    t
                }
                toJSON() {
                    return {
                ...
                static fromJSON(e) {
                    ...
                    if (!r || !n)
                        return null;
                    const i = new ze(r,n);
                    return i.idToken = t.idToken || void 0,
            ...
            class Ge extends xe {
                ...
                _linkToIdToken(e, t) {
                    return async function(e, t) {
                        var r = await re(e, "POST", "/v1/accounts:signInWithPhoneNumber", Q(e, t));
                        if (r.temporaryProof)
                ...
                _getReauthenticationResolver(e) {
                    return async function(e, t) {
                        return re(e, "POST", "/v1/accounts:signInWithPhoneNumber", Q(e, Object.assign(Object.assign({}, t), {
                            operation: "REAUTH"
                        })), Be)
                    }(e, this._makeVerificationRequest())
                }
                _makeVerificationRequest() {
                    var {temporaryProof: e, phoneNumber: t, verificationId: r, verificationCode: n} = this.params;
                    return e && t ? {
                        temporaryProof: e,
                        phoneNumber: t
                    } : {
                ...
                static fromJSON(e) {
                    var {verificationId: t, verificationCode: r, phoneNumber: n, temporaryProof: i} = e = "string" == typeof e ? JSON.parse(e) : e;
                    return r || t || n || i ? new Ge({
                        verificationId: t,
                        verificationCode: r,
                        phoneNumber: n,
                        temporaryProof: i
            ...
            class Ke {
                constructor(e) {
                    ...
                    this.operation = i,
                    this.code = n,
                    this.continueUrl = null !== (n = t.continueUrl) && void 0 !== n ? n : null,
                    this.languageCode = null !== (n = t.languageCode) && void 0 !== n ? n : null,
                    this.tenantId = null !== (t = t.tenantId) && void 0 !== t ? t : null
                }
                static parseLink(e) {
                    var t, r, n, t = (t = m(g(e = e)).link,
                    r = t ? m(g(t)).deep_link_id : null,
                    ((n = m(g(e)).deep_link_id) ? m(g(n)).link : null) || n || r || t || e);
                    try {
                        return new Ke(t)
                    } catch (e) {
                        return null
            ...
            class $e {
                ...
                static credentialWithLink(e, t) {
                    ...
                    return j(r, "argument-error"),
                    He._fromEmailAndCode(e, r.code, r.tenantId)
                }
            }
            ...
            class Xe extends Ye {
                static credentialFromJSON(e) {
                    var t = "string" == typeof e ? JSON.parse(e) : e;
                    return j("providerId"in t && "signInMethod"in t, "argument-error"),
                    ze._fromParams(t)
                }
                credential(e) {
                ...
                _credential(e) {
                    return j(e.idToken || e.accessToken, "argument-error"),
                    ze._fromParams(Object.assign(Object.assign({}, e), {
                        providerId: this.providerId,
                ...
                static oauthCredentialFromTaggedObject({_tokenResponse: e}) {
                    if (!e)
                        return null;
                    var {oauthIdToken: t, oauthAccessToken: r, oauthTokenSecret: n, pendingToken: i, nonce: s, providerId: a} = e;
                    if (!(r || n || t || i))
                        return null;
                    if (!a)
                        return null;
            ...
            class tt extends xe {
                ...
                static fromJSON(e) {
                    var {providerId: t, signInMethod: r, pendingToken: n} = "string" == typeof e ? JSON.parse(e) : e;
            ...
            class rt extends Je {
                constructor(e) {
                    j(e.startsWith("saml."), "argument-error"),
                    super(e)
                }
                static credentialFromResult(e) {
            ...
            class st {
                ...
                static async _fromIdTokenResponse(e, t, r, n=!1) {
                    var i = await ve._fromIdTokenResponse(e, r, n)
                      , s = at(r);
                    return new st({
                        user: i,
                        providerId: s,
            ...
            function lt(t, r, e, n) {
                const i = "reauthenticate" === r ? e._getReauthenticationResolver(t) : e._getIdTokenResponse(t);
                return i.catch(e => {
            ...
            async function dt(e, t, r=!1) {
                var n = await ce(e, t._linkToIdToken(e.auth, await e.getIdToken()), r);
                return st._forOperation(e, "link", n)
            }
            async function ht(e, t, r) {
                await he(t);
                const n = ct(t.providerData);
            ...
            async function pt(e, t, r=!1) {
                var n = e["auth"]
                  , i = "reauthenticate";
                try {
                    var s = await ce(e, lt(n, i, t, e), r);
                    j(s.idToken, n, "internal-error");
                    var a = le(s.idToken);
                    j(a, n, "internal-error");
                    var o = a["sub"];
                    return j(e.uid === o, n, "user-mismatch"),
                    st._forOperation(e, i, s)
                } catch (e) {
                    throw "auth/user-not-found" === (null === e || void 0 === e ? void 0 : e.code) && M(n, "user-mismatch"),
                    e
                }
            }
            async function ft(e, t, r=!1) {
                var n = await lt(e, "signIn", t)
                  , n = await st._fromIdTokenResponse(e, "signIn", n);
                return r || await e._updateCurrentUser(n.user),
                n
            }
            ...
            async function mt(e, t) {
                var r = I(e);
                return await ht(!1, r, t.providerId),
                dt(r, t)
            }
            ...
            async function _t(e, t) {
                const r = Le(e);
                var n = await re(r, "POST", "/v1/accounts:signInWithCustomToken", Q(r, {
                    token: t,
                    returnSecureToken: !0
                }))
                  , n = await st._fromIdTokenResponse(r, "signIn", n);
                return await r._updateCurrentUser(n.user),
                n
            }
            class yt {
                constructor(e, t) {
                ...
                static _fromServerResponse(e, t) {
                    return "phoneInfo"in t ? It._fromServerResponse(e, t) : M(e, "internal-error")
                }
            }
            class It extends yt {
                constructor(e) {
            ...
            function wt(e, t, r) {
                var n;
                j(0 < (null === (n = r.url) || void 0 === n ? void 0 : n.length), e, "invalid-continue-uri"),
                j(void 0 === r.dynamicLinkDomain || 0 < r.dynamicLinkDomain.length, e, "invalid-dynamic-link-domain"),
                t.continueUrl = r.url,
                t.dynamicLinkDomain = r.dynamicLinkDomain,
                t.canHandleCodeInApp = r.handleCodeInApp,
                r.iOS && (j(0 < r.iOS.bundleId.length, e, "missing-ios-bundle-id"),
                t.iOSBundleId = r.iOS.bundleId),
                r.android && (j(0 < r.android.packageName.length, e, "missing-android-pkg-name"),
            ...
            async function bt(e, t) {
                await ee(e = I(e), "POST", "/v1/accounts:update", Q(e, {
                    oobCode: t
                }))
            }
            async function kt(e, t) {
                ...
                let s = null;
                return n.mfaInfo && (s = yt._fromServerResponse(Le(r), n.mfaInfo)),
                {
                    data: {
            ...
            async function Rt(e, t) {
                var r = G() ? B() : "http://localhost"
                  , r = (await ee(e = I(e), "POST", "/v1/accounts:createAuthUri", Q(e, {
                    identifier: t,
                    continueUri: r
                })))["signinMethods"];
                return r || []
            ...
            async function Ot(e, {displayName: t, photoURL: r}) {
                if (void 0 !== t || void 0 !== r) {
                    ...
                    var n = await i.getIdToken()
                      , n = await ce(i, async function(e, t) {
                        return ee(e, "POST", "/v1/accounts:update", t)
                    }(i.auth, {
                        idToken: n,
                        displayName: t,
                    ...
                    const s = i.providerData.find( ({providerId: e}) => "password" === e);
                    s && (s.displayName = i.displayName,
                    s.photoURL = i.photoURL),
            ...
            function Ft(e) {
                ...
                return t.isAnonymous && !r ? {
                    ...
                    var t = e["providerId"]
                      ...
                      , n = e.isNewUser || "identitytoolkit#SignupNewUserResponse" === e.kind;
                    if (!t && null != e && e.idToken) {
                        var i = null === (i = null === (i = le(e.idToken)) || void 0 === i ? void 0 : i.firebase) || void 0 === i ? void 0 : i.sign_in_provider;
                        if (i) {
            ...
            class xt {
                ...
                static fromJSON(e) {
                    ...
                    if (null != e && e.multiFactorSession) {
                        if (null !== (t = e.multiFactorSession) && void 0 !== t && t.pendingCredential)
                            return xt._fromMfaPendingCredential(e.multiFactorSession.pendingCredential);
                        if (null !== (t = e.multiFactorSession) && void 0 !== t && t.idToken)
                ...
                static _fromError(e, i) {
                    ...
                    return new Vt(o,t,async e => {
                        ...
                        case "signIn":
                            ...
                            return await s._updateCurrentUser(n.user),
                            n;
                        case "reauthenticate":
                            return j(i.user, s, "internal-error"),
            ...
            class jt {
                constructor(t) {
                    ...
                    t._onReload(e => {
                        e.mfaInfo && (this.enrolledFactors = e.mfaInfo.map(e => yt._fromServerResponse(t.auth, e)))
                    }
                    )
                }
                static _fromUser(e) {
                ...
                async enroll(e, t) {
                    ...
                    var n = await this.getSession()
                      , n = await ce(this.user, r._process(this.user.auth, n, t));
                    return await this.user._updateTokensIfNecessary(n),
                    this.user.reload()
                }
                async unenroll(e) {
                    const t = "string" == typeof e ? e : e.uid;
                    var r, n = await this.user.getIdToken(), n = await ce(this.user, (r = this.user.auth,
                    e = {
                        idToken: n,
                        mfaEnrollmentId: t
                    },
                    ...
                    try {
                        ...
                        if ("auth/user-token-expired" !== (null === e || void 0 === e ? void 0 : e.code))
                            throw e
                    }
                }
            }
            ...
            class qt {
                ...
                _isAvailable() {
                    try {
                        return this.storage ? (this.storage.setItem(Ht, "1"),
            ...
            class zt extends qt {
                constructor() {
                    ...
                    this.localCache = {},
                    this.pollTimer = null,
                    this.safariLocalStorageNotSynced = (Te(e = d()) || Ae(e)) && function() {
                        try {
                ...
                onStorageEvent(e, t=!1) {
                    if (e.key) {
                        ...
                        ;
                        const i = this.storage.getItem(n);
                        c() && 10 === document.documentMode && i !== e.newValue && e.newValue !== e.oldValue ? setTimeout(r, 10) : r()
                    } else
            ...
            class $t {
                ...
                async handleEvent(e) {
                    ...
                    s = await Promise.all(s.map(async e => {
                        try {
                            return {
                                fulfilled: !0,
                                value: await e
            ...
            function Zt() {
                return void 0 !== Xt().WorkerGlobalScope && "function" == typeof Xt().importScripts
            }
            ...
            function nr(e, t) {
                return e.transaction([er], t ? "readwrite" : "readonly").objectStore(er)
            }
            function ir() {
                ...
                return new Promise( (r, t) => {
                    ...
                    n.addEventListener("success", async () => {
                        const e = n.result;
                        var t;
                        e.objectStoreNames.contains(er) ? r(e) : (e.close(),
            ...
            class or {
                ...
                async _openDb() {
                    return this.db || (this.db = await ir(),
                    this.db)
                }
                ...
                async initializeSender() {
                    ...
                    this.activeServiceWorker = await async function() {
                        if (null === navigator || void 0 === navigator || !navigator.serviceWorker)
                            return null;
                        try {
                    ...
                    this.activeServiceWorker && (this.sender = new Yt(this.activeServiceWorker),
                    (r = await this.sender._send("ping", {}, 800)) && null !== (e = r[0]) && void 0 !== e && e.fulfilled && null !== (t = r[0]) && void 0 !== t && t.value.includes("keyChanged") && (this.serviceWorkerReceiverAvailable = !0))
                }
                ...
                async _set(t, r) {
                    return this._withPendingWrite(async () => (await this._withRetries(e => sr(e, t, r)),
                    this.localCache[t] = r,
                ...
                async _get(t) {
                    var e = await this._withRetries(e => async function(e, t) {
                        var r = nr(e, !1).get(t);
                        return void 0 === (r = await new rr(r).toPromise()) ? null : r.value
                    }(e, t));
                    return this.localCache[t] = e
                }
                async _remove(t) {
                    return this._withPendingWrite(async () => (await this._withRetries(e => ar(e, t)),
                    delete this.localCache[t],
                    this.notifyServiceWorker(t)))
                }
                async _poll() {
                    var e, t, r = await this._withRetries(e => {
                        var t = nr(e, !1).getAll();
                    ...
                    for ({fbase_key: e, value: t} of r)
                        i.add(e),
                        JSON.stringify(this.localCache[e]) !== JSON.stringify(t) && (this.notifyListeners(e, t),
                        n.push(e));
                    for (const s of Object.keys(this.localCache))
                        this.localCache[s] && !i.has(s) && (this.notifyListeners(s, null),
                        n.push(s));
                    return n
                }
                notifyListeners(e, t) {
            ...
            function cr(i) {
                return new Promise( (e, r) => {
                    ...
                    t.charset = "UTF-8",
                    (null !== (n = null === (n = document.getElementsByTagName("head")) || void 0 === n ? void 0 : n[0]) && void 0 !== n ? n : document).appendChild(t)
                }
                )
            }
            function ur(e) {
            ...
            class dr {
                ...
                render(e, t) {
                    var r = this.counter;
                    return this._widgets.set(r, new hr(e,this.auth.name,t || {})),
                    this.counter++,
                    r
                }
                reset(e) {
            ...
            class vr {
                constructor() {
                    ...
                    this.hostLanguage = "",
                    this.counter = 0,
                    this.librarySeparatelyLoaded = !(null === (e = Xt().grecaptcha) || void 0 === e || !e.render)
                }
                load(s, a="") {
                    var e;
                    return j((e = a).length <= 6 && /^\s*[a-zA-Z0-9\-]*\s*$/.test(e), s, "argument-error"),
                    this.shouldResolveImmediately(a) ? Promise.resolve(Xt().grecaptcha) : new Promise( (t, r) => {
                        ...
                        Xt()[pr] = () => {
                            ...
                            if (e) {
                                ...
                                r(U(s, "internal-error"))
                        }
                        ,
                        cr(`https://www.google.com/recaptcha/api.js??${v({
                            onload: pr,
                            render: "explicit",
                            hl: a
                        })}`).catch( () => {
                ...
                shouldResolveImmediately(e) {
                    var t;
                    return !(null === (t = Xt().grecaptcha) || void 0 === t || !t.render) && (e === this.hostLanguage || 0 < this.counter || this.librarySeparatelyLoaded)
                }
            }
            class mr {
                async load(e) {
            ...
            class yr {
                constructor(e, t=Object.assign({}, _r), r) {
                    ...
                    j("undefined" != typeof document, this.auth, "operation-not-supported-in-this-environment");
                    var n = "string" == typeof e ? document.getElementById(e) : e;
                    j(n, this.auth, "argument-error"),
                    this.container = n,
                    this.parameters.callback = this.makeTokenCallback(this.parameters.callback),
                    this._recaptchaLoader = new (this.auth.settings.appVerificationDisabledForTesting ? mr : vr),
                ...
                async verify() {
                    ...
                    return t || new Promise(t => {
                        const r = e => {
                            e && (this.tokenChangeListeners.delete(r),
                            t(e))
                        }
                        ;
                ...
                validateStartingState() {
                    ...
                    j(this.isInvisible || !this.container.hasChildNodes(), this.auth, "argument-error"),
                    j("undefined" != typeof document, this.auth, "operation-not-supported-in-this-environment")
                }
                makeTokenCallback(r) {
                    return t => {
                ...
                async makeRenderPromise() {
                    ...
                    !this.widgetId) {
                        ...
                        var t;
                        this.isInvisible || (t = document.createElement("div"),
                        e.appendChild(t),
                        e = t),
                ...
                async init() {
                    ...
                    await function() {
                        ...
                        return new Promise(e => {
                            ...
                            window.addEventListener("load", t)) : e()
                        }
                        ).catch(e => {
                            throw t && window.removeEventListener("load", t),
                            e
                        }
                        )
                    }(),
                    this.recaptcha = await this._recaptchaLoader.load(this.auth, this.auth.languageCode || void 0);
                    var e = await ((await ee(this.auth, "GET", "/v1/recaptchaParams")).recaptchaSiteKey || "");
                    j(e, this.auth, "internal-error"),
                    this.parameters.sitekey = e
                }
                getAssertedRecaptcha() {
                    return j(this.recaptcha, this.auth, "internal-error"),
                    this.recaptcha
                }
            }
            class Ir {
            ...
            async function wr(t, r, n) {
                var i, s, a, o, l, c, u = await n.verify();
                try {
                    ...
                    "session"in e) {
                        var d = e.session;
                        if ("phoneNumber"in e)
                            return j("enroll" === d.type, t, "internal-error"),
                            (l = t,
                            c = {
                            ...
                            await ee(l, "POST", "/v2/accounts/mfaEnrollment:start", Q(l, c))).phoneSessionInfo.sessionInfo;
                        j("signin" === d.type, t, "internal-error");
                        var h = (null === (i = e.multiFactorHint) || void 0 === i ? void 0 : i.uid) || e.multiFactorUid;
                        return j(h, t, "missing-multi-factor-info"),
                        (o = {
                        ...
                        await ee(t, "POST", "/v2/accounts/mfaSignIn:start", Q(t, o))).phoneResponseInfo.sessionInfo
                    }
                    var p = (s = t,
                    a = {
                        phoneNumber: e.phoneNumber,
                    ...
                    await ee(s, "POST", "/v1/accounts:sendVerificationCode", Q(s, a)))["sessionInfo"];
                    return p
                } finally {
                    n._reset()
                }
            ...
            function br(e, t) {
                return t ? z(t) : (j(e._popupRedirectResolver, e, "argument-error"),
                e._popupRedirectResolver)
            }
            Tr.PROVIDER_ID = "phone",
            Tr.PHONE_SIGN_IN_METHOD = "phone";
            class kr extends xe {
                constructor(e) {
                    super("custom", "custom"),
                    this.params = e
            ...
            function Rr(e) {
                var {auth: t, user: r} = e;
                return j(r, t, "internal-error"),
                pt(r, new kr(e), e.bypassAuthState)
            }
            async function Sr(e) {
                var {auth: t, user: r} = e;
                return j(r, t, "internal-error"),
                dt(r, new kr(e), e.bypassAuthState)
            }
            class Ar {
                ...
                async onAuthEvent(e) {
                    var {urlResponse: t, sessionId: r, postBody: n, tenantId: i, error: s, type: a} = e;
                    if (s)
                        this.reject(s);
                    else {
                        n = {
            ...
            class Nr extends Ar {
                ...
                async executeNotNull() {
                    ...
                    return j(e, this.auth, "internal-error"),
                    e
                }
                async onExecution() {
                ...
                pollUserCancellation() {
                    const t = () => {
                        ...
                        , 2e3) : this.pollId = window.setTimeout(t, Or.get())
                    }
                    ;
                    t()
                }
            ...
            class Lr extends Ar {
                ...
                async execute() {
                    ...
                    return this.bypassAuthState || Cr.set(this.auth._key(), () => Promise.resolve(null)),
                    t()
                }
                async onAuthEvent(e) {
            ...
            async function Wr(e, t, r=!1) {
                ...
                const s = new Lr(n,i,r)
                  , a = await s.execute();
                return a && !r && (delete a.user._redirectEventId,
            ...
            class qr {
                ...
                onEvent(t) {
                    ...
                    return this.consumers.forEach(e => {
                        this.isEventForConsumer(t, e) && (r = !0,
                        this.sendToConsumer(t, e),
                    ...
                    }(t) || (this.hasHandledPotentialRedirect = !0,
                    r || (this.queuedRedirectEvent = t,
                    r = !0)),
                    r
                }
                sendToConsumer(e, t) {
                    var r;
                    e.error && !Br(e) ? (r = (null === (r = e.error.code) || void 0 === r ? void 0 : r.split("auth/")[1]) || "internal-error",
                    t.onError(U(this.auth, r))) : t.onAuthEvent(e)
                }
                ...
                hasEventBeenHandled(e) {
                    return 6e5 <= Date.now() - this.lastProcessedEventTime && this.cachedEventUids.clear(),
                ...
                new Promise( (e, t) => {
                    function r() {
                        ...
                        gapi.load("gapi.iframes", {
                            ...
                            ontimeout: () => {
                                Xr(),
                                t(U(i, "network-request-failed"))
                            }
                            ,
                            timeout: Yr.get()
                        })
                    }
                    if (null !== (n = null === (n = Xt().gapi) || void 0 === n ? void 0 : n.iframes) && void 0 !== n && n.Iframe)
                        e(gapi.iframes.getContext());
                    else {
                        if (null === (n = Xt().gapi) || void 0 === n || !n.load) {
                            ...
                            ,
                            cr(`https://apis.google.com/js/api.js?onload=${n}`).catch(e => t(e))
                        }
                        r()
                    }
                }
            ...
            const en = new $(5e3,15e3)
              ...
              , sn = new Map([["identitytoolkit.googleapis.com", "p"], ["staging-identitytoolkit.sandbox.googleapis.com", "s"], ["test-identitytoolkit.sandbox.googleapis.com", "t"]]);
            async function an(a) {
                const e = await Qr(a);
                var t = Xt().gapi;
                return j(t, a, "internal-error"),
                e.open({
                    where: document.body,
                    url: function(e) {
                        var t = e.config;
                        j(t.authDomain, e, "auth-domain-config-required");
                        var r = t.emulator ? J(t, rn) : `https://${e.config.authDomain}/${tn}`;
                        const n = {
                            apiKey: t.apiKey,
                            appName: e.name,
                            v: li.SDK_VERSION
            ...
            function cn(e, t, r, n=500, i=600) {
                var s = Math.max((window.screen.availHeight - i) / 2, 0).toString()
                  , a = Math.max((window.screen.availWidth - n) / 2, 0).toString();
                let o = "";
                const l = Object.assign(Object.assign({}, on), {
                    width: n.toString(),
                    height: i.toString(),
                    top: s,
                    left: a
                ...
                s = d().toLowerCase();
                r && (o = be(s) ? "_blank" : r),
                we(s) && (t = t || "http://localhost",
                l.scrollbars = "yes");
                var c, a = Object.entries(l).reduce( (e, [t,r]) => `${e}${t}=${r},`, "");
                if ([r=d()] = [s],
                Ae(r) && null !== (c = window.navigator) && void 0 !== c && c.standalone && "_self" !== o)
                    return function(e, t) {
            ...
            function hn(e, t, r, n, i, s) {
                ...
                if (t instanceof Je) {
                    ...
                    for (var [o,l] of Object.entries(s || {}))
                        a[o] = l
                }
                if (t instanceof Ye) {
                ...
                for (const d of Object.keys(c))
                    void 0 === c[d] && delete c[d];
                return `${e = [e["config"]][0],
                e.emulator ? J(e, dn) : `https://${e.authDomain}/${un}`}?${v(c).slice(1)}`
            }
            ...
            const fn = class {
                ...
                async _openPopup(e, t, r, n) {
                    var i;
                    return H(null === (i = this.eventManagers[e._key()]) || void 0 === i ? void 0 : i.manager, "_initialize() not called before _openPopup()"),
                    cn(e, hn(e, t, r, B(), n), Jt())
                }
                ...
                _initialize(e) {
                    ...
                    if (this.eventManagers[t]) {
                        ...
                        return n ? Promise.resolve(n) : (H(r, "If manager is not set, promise should be"),
                        r)
                    }
                ...
                async initAndGetManager(t) {
                    ...
                    return e.register("authEvent", e => {
                        return j(null == e ? void 0 : e.authEvent, t, "invalid-auth-event"),
                        {
                ...
                _isIframeWebStorageSupported(r, n) {
                    ...
                    e.send(pn, {
                        ...
                        var t = null === (t = null == e ? void 0 : e[0]) || void 0 === t ? void 0 : t[pn];
                        void 0 !== t && n(!!t),
                        M(r, "internal-error")
                    }
                    , gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)
                ...
                _originValidation(e) {
                    var t = e._key();
                    return this.originValidationPromises[t] || (this.originValidationPromises[t] = Jr(e)),
            ...
            class mn {
                constructor() {}
                static assertion(e) {
                    return vn._fromCredential(e)
                }
            }
            mn.FACTOR_ID = "phone";
            var gn, _n = "@firebase/auth";
            class yn {
                constructor(e) {
                    this.auth = e,
                ...
                addAuthTokenListener(t) {
                    ...
                    this.internalListeners.has(t) || (e = this.auth.onIdTokenChanged(e => {
                        t((null === e || void 0 === e ? void 0 : e.stsTokenManager.accessToken) || null)
                    }
                    ),
            ...
            gn = "Browser",
            li._registerComponent(new R("auth", (e, {options: n}) => {
                ...
                return ( (e, t) => {
                    ...
                    j(!(null !== s && void 0 !== s && s.includes(":")), "argument-error", {
                        appName: e.name
                    });
                    var r = {
                        apiKey: i,
            ...
            li._registerComponent(new R("auth-internal",e => {
                var t = Le(e.getProvider("auth").getImmediate());
                return e = t,
                new yn(e)
            }
            ,"PRIVATE").setInstantiationMode("EXPLICIT")),
            li.registerVersion(_n, "0.20.5", function(e) {
                switch (e) {
                case "Node":
                    return "node";
                case "ReactNative":
            ...
            async function wn(e, t, r) {
                ...
                const s = {};
                return Ae() ? s.ibi = n.packageName : Ee() ? s.apn = n.packageName : M(e, "operation-not-supported-in-this-environment"),
                n.displayName && (s.appDisplayName = n.displayName),
                s.sessionId = i,
                hn(e, r, t.type, void 0, null !== (i = t.eventId) && void 0 !== i ? i : void 0, s)
            }
            function Tn(n) {
                const i = In()["cordova"];
                return new Promise(r => {
                    i.plugins.browsertab.isAvailable(e => {
                        let t = null;
                        e ? i.plugins.browsertab.openUrl(n) : t = i.InAppBrowser.open(n, (e = d(),
                        /(iPad|iPhone|iPod).*OS 7_\d/i.test(e) || /(iPad|iPhone|iPod).*OS 8_\d/i.test(e) ? "_blank" : "_system"), "location=yes"),
                        r(t)
                    }
                    )
                }
            ...
            async function Rn(e) {
                ...
                return t && await An()._remove(On(e)),
                t
            }
            function Sn(e, t) {
                var r, n, i;
            ...
            const Pn = class {
                ...
                async _openRedirect(e, t, r, n) {
                    ...
                    i = e,
                    o = In(),
                    j("function" == typeof (null === (s = null == o ? void 0 : o.universalLinks) || void 0 === s ? void 0 : s.subscribe), i, "invalid-cordova-configuration", {
                        missingPlugin: "cordova-universal-links-plugin-fix"
                    }),
                    j(void 0 !== (null === (s = null == o ? void 0 : o.BuildInfo) || void 0 === s ? void 0 : s.packageName), i, "invalid-cordova-configuration", {
                        missingPlugin: "cordova-plugin-buildInfo"
                    }),
                    j("function" == typeof (null === (s = null === (s = null === (s = null == o ? void 0 : o.cordova) || void 0 === s ? void 0 : s.plugins) || void 0 === s ? void 0 : s.browsertab) || void 0 === s ? void 0 : s.openUrl), i, "invalid-cordova-configuration", {
                        missingPlugin: "cordova-plugin-browsertab"
                    }),
                    j("function" == typeof (null === (s = null === (s = null === (s = null == o ? void 0 : o.cordova) || void 0 === s ? void 0 : s.plugins) || void 0 === s ? void 0 : s.browsertab) || void 0 === s ? void 0 : s.isAvailable), i, "invalid-cordova-configuration", {
                        missingPlugin: "cordova-plugin-browsertab"
                    }),
                    j("function" == typeof (null === (o = null === (o = null == o ? void 0 : o.cordova) || void 0 === o ? void 0 : o.InAppBrowser) || void 0 === o ? void 0 : o.open), i, "invalid-cordova-configuration", {
                        ...
                        try {
                            await new Promise( (r, e) => {
                                ...
                                function n() {
                                    var e;
                                    r();
                                    const t = null === (e = c.plugins.browsertab) || void 0 === e ? void 0 : e.close;
                                    "function" == typeof t && t(),
                                    "function" == typeof (null == l ? void 0 : l.close) && l.close()
                                }
                                function i() {
                ...
                _originValidation(e) {
                    ...
                    return this.originValidationPromises[t] || (this.originValidationPromises[t] = async function(e) {
                        var t = In()["BuildInfo"];
                        const r = {};
                        Ae() ? r.iosBundleId = t.packageName : Ee() ? r.androidPackageName = t.packageName : M(e, "operation-not-supported-in-this-environment"),
                        await Gr(e, r)
                    }(e)),
                    this.originValidationPromises[t]
                }
                attachCallbackListeners(n, i) {
                    ...
                    In().handleOpenURL = async e => {
                        if (e.toLowerCase().startsWith(l) && a({
                            url: e
                        }),
                        "function" == typeof o)
                            try {
            ...
            function Mn(e=d()) {
                return !("file:" !== Dn() && "ionic:" !== Dn() && "capacitor:" !== Dn() || !e.toLowerCase().match(/iphone|ipad|ipod|android/))
            }
            function Un(e=d()) {
                return c() && 11 === (null === document || void 0 === document ? void 0 : document.documentMode) || ([e=d()] = [e],
                /Edge\/\d+/.test(e))
            }
            function Fn() {
                try {
            ...
            function Vn() {
                return ("http:" === Dn() || "https:" === Dn() || o() || Mn()) && !(l() || a()) && Fn() && !xn()
            }
            function jn() {
            ...
            class Kn {
                ...
                async _initialize(e) {
                    return await this.selectUnderlyingResolver(),
                ...
                get assertedUnderlyingResolver() {
                    return Gn(this.underlyingResolver, "internal-error"),
                    this.underlyingResolver
                }
                async selectUnderlyingResolver() {
                    var e;
                    this.underlyingResolver || (e = await (!!jn() && new Promise(e => {
                        const t = setTimeout( () => {
                            e(!1)
                        }
                        , 1e3);
            ...
            function Jn(e, t) {
                var r, n, i, s = null === (n = t.customData) || void 0 === n ? void 0 : n._tokenResponse;
                if ("auth/multi-factor-auth-required" === (null === t || void 0 === t ? void 0 : t.code)) {
                    const o = t;
                    o.resolver = new Qn(e,(r = t,
                    i = I(e),
                    j((a = r).customData.operationType, i, "argument-error"),
                    j(null === (n = a.customData._serverResponse) || void 0 === n ? void 0 : n.mfaPendingCredential, i, "argument-error"),
                    Vt._fromError(i, a)))
                } else if (s) {
                    var a = Yn(t);
                    const l = t;
            ...
            function Yn(e) {
                ...
                case S.TWITTER:
                    ...
                    break;
                default:
                    var {oauthIdToken: i, oauthAccessToken: s, oauthTokenSecret: a, pendingToken: o, nonce: l} = t;
                    return s || a || i || o ? o ? r.startsWith("saml.") ? tt._create(r, o) : ze._fromParams({
                        providerId: r,
                        signInMethod: r,
                        pendingToken: o,
                        idToken: i,
                ...
                return e instanceof h ? n.credentialFromError(e) : n.credentialFromResult(e)
            }
            function Xn(t, e) {
                return e.catch(e => {
                    throw e instanceof h && Jn(t, e),
                    e
                }
                ).then(e => {
            ...
            class ei {
                constructor(e) {
                    var t;
                    this._delegate = e,
                    this.multiFactor = (t = I(e),
                    Wt.has(t) || Wt.set(t, jt._fromUser(t)),
                    Wt.get(t))
                }
                static getOrCreate(e) {
                    return ei.USER_MAP.has(e) || ei.USER_MAP.set(e, new ei(e)),
                    ei.USER_MAP.get(e)
                }
                delete() {
                ...
                async linkWithCredential(e) {
                    return Xn(this.auth, mt(this._delegate, e))
                }
                async linkWithPhoneNumber(e, t) {
                    return Zn(this.auth, async function(e, t, r) {
                        const n = I(e);
                        await ht(!1, n, "phone");
                ...
                async linkWithPopup(e) {
                    return Xn(this.auth, async function(e, t, r) {
                        var n = I(e);
                        x(n.auth, t, Je);
                        var i = br(n.auth, r);
                ...
                async linkWithRedirect(e) {
                    return await zn(Le(this.auth)),
                    jr(this._delegate, e, Kn)
                }
                ...
                async reauthenticateWithRedirect(e) {
                    return await zn(Le(this.auth)),
                    Vr(this._delegate, e, Kn)
                }
                sendEmailVerification(e) {
                    return St(this._delegate, e)
                }
                async unlink(e) {
                    return await ut(this._delegate, e),
                    this
                }
                updateEmail(e) {
            ...
            class ri {
                constructor(e, t) {
                    if (this.app = e,
                    t.isInitialized())
                        return this._delegate = t.getImmediate(),
                        void this.linkUnderlyingAuth();
                    var r = e.options["apiKey"];
                    ti(r, "invalid-api-key", {
                        appName: e.name
                    }),
                    ti(r, "invalid-api-key", {
                        appName: e.name
                    ...
                    this._delegate = t.initialize({
                        options: {
                            persistence: function(e, t) {
                                ...
                                "undefined" == typeof self || r.includes(lr) || r.push(lr);
                                if ("undefined" != typeof window)
                                    for (const n of [Bt, Kt])
                ...
                get currentUser() {
                    return this._delegate.currentUser ? ei.getOrCreate(this._delegate.currentUser) : null
                }
                get languageCode() {
                ...
                async createUserWithEmailAndPassword(e, t) {
                    return Xn(this._delegate, async function(e, t, r) {
                        const n = Le(e);
                        var i = await it(n, {
                            returnSecureToken: !0,
                            email: t,
                ...
                isSignInWithEmailLink(e) {
                    ...
                    e = e,
                    "EMAIL_SIGNIN" === (null == (t = Ke.parseLink(e)) ? void 0 : t.operation);
                    var t
                }
                async getRedirectResult() {
                    ti(Vn(), this._delegate, "operation-not-supported-in-this-environment");
                    var e, t, r = (e = this._delegate,
                    t = Kn,
                    await Le(e)._initializationPromise,
                    await Wr(e, t, !1));
                    return r ? Xn(this._delegate, Promise.resolve(r)) : {
                        credential: null,
                        user: null
                    }
                }
                ...
                async setPersistence(e) {
                    ...
                    l() ? Hn(r !== Wn.SESSION, t, "unsupported-persistence-type") : a() ? Hn(r === Wn.NONE, t, "unsupported-persistence-type") : xn() ? Hn(r === Wn.NONE || r === Wn.LOCAL && u(), t, "unsupported-persistence-type") : Hn(r === Wn.NONE || Fn(), t, "unsupported-persistence-type");
                    let n;
                    switch (e) {
                    case Wn.SESSION:
                        n = Kt;
                ...
                signInAnonymously() {
                    return Xn(this._delegate, async function(e) {
                        const t = Le(e);
                        ...
                        return await t._updateCurrentUser(r.user),
                        r
                    }(this._delegate))
                }
                signInWithCredential(e) {
                    return Xn(this._delegate, vt(this._delegate, e))
                }
                signInWithCustomToken(e) {
                    return Xn(this._delegate, _t(this._delegate, e))
                }
                signInWithEmailAndPassword(e, t) {
                    return Xn(this._delegate, (r = this._delegate,
                    e = e,
                    t = t,
                    vt(I(r), $e.credential(e, t))));
                    var r
                }
                signInWithEmailLink(e, t) {
                    return Xn(this._delegate, async function(e, t, r) {
                        ...
                        return j(i._tenantId === (n.tenantId || null), n, "tenant-id-mismatch"),
                        vt(n, i)
                    }(this._delegate, e, t))
                }
                signInWithPhoneNumber(e, t) {
                    return Zn(this._delegate, async function(e, t, r) {
                        const n = Le(e);
                ...
                async signInWithPopup(e) {
                    return ti(Vn(), this._delegate, "operation-not-supported-in-this-environment"),
                    Xn(this._delegate, async function(e, t, r) {
                        var n = Le(e);
                        x(e, t, Je);
                        var i = br(n, r);
            ...
            class ai {
                constructor(e, t, r=i.default.app()) {
                    var n;
                    si(null === (n = r.options) || void 0 === n ? void 0 : n.apiKey, "invalid-api-key", {
                        appName: r.name
                    }),
            ...
            (Ln = i.default).INTERNAL.registerComponent(new R("auth-compat",e => {
            ...
            Ln.registerVersion("@firebase/auth-compat", "0.2.18")
        }
        ).apply(this, arguments)
    } catch (e) {
        throw console.error(e),
        new Error("Cannot instantiate firebase-auth-compat.js - be sure to load firebase-app.js first.")
    }
});
